...
prof2013 <- data.frame(variable = col_names,
                       completeness = c(1.0,1.0,1.0,.9707383,.9707383,.9779461,.9779461,.4677514,.1565640),
                       validity = c(1,1,1,1,1,1,1,1,1),
                       uniqueness = c(1872049,365,59,833,833,32801,34443,5,5)
                       )

write.csv(prof2013, "src/shiny-markdown/2013.csv", row.names = FALSE) 